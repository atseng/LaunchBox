...
describe AppsController do
  ...
  let(:valid_attributes) { { "name" => "MyString", "codebase_url" => "URL1", "email" => "a@a.com", "props" => 0, "url" => "URL2" } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested app" do
        ...
        App.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
